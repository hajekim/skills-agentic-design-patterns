...
description: This skill should be used when the user wants to understand "reasoning models", "thinking tokens", "extended thinking", "LLM internal reasoning", "o1 style reasoning", "Gemini thinking model", "chain of thought internally", "reasoning vs standard models", "when to use reasoning models", "inference-time compute scaling", "deliberate reasoning LLMs", or choose between standard and reasoning-optimized LLMs for agentic tasks. Apply this skill to understand, select, and integrate reasoning engine capabilities into agent designs. Also responds to Korean: "추론 모델", "사고 토큰", "확장 사고", "LLM 내부 추론", "추론 vs 표준 모델", "추론 엔진 선택", "추론 모델 통합".
version: 1.0.0
---
